...
figdrink = Recipe.create(name:"Fig Martini", ingredients: "3 fresh figs, quartered, 3 tablespoons fig jam, Juice of 1 lemon, 2 tablespoons honey, 6 oz vodka, Sliced fresh figs, as optional garnish", instructions: "In a cocktail shaker, muddle the figs, jam, lemon juice, and honey together until the figs are mostly broken down.
...
pudding = Recipe.create(name: "Banana Pudding", ingredients: "4 cups Vegan Peanut Butter Pudding, 3 cups full-fat coconut milk or cream, Stevia or powdered sugar",
...
marg = Recipe.create(name: "Pink Grapefruit Margarita", 
        ingredients: "1 lime, cut in wedges, optional, Kosher salt, optional, 1 cup ruby red grapefruit juice, 1/2 cup freshly squeezed lime juice (4 limes), 1 cup orange liqueur, such a Triple Sec, 2 cups ice, 1 cup white tequila",
...
ingredients: "1 large cauliflower, 2 tbsp olive oil, ½ tsp each ground cinnamon, cumin and coriander, 2 tbsp harissa paste - plus extra drizzle, 1l hot vegetable or chicken stock, 50g toasted flaked almond, plus extra to serve", 
...
corntacos = Recipe.create(name: "Grilled Corn Tacos", ingredients: "Handful of whole green beans, about 1 cup
...
RecipeDiet.create(recipe: corntacos, diet: gluten_free)
