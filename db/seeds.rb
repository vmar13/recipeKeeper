...
avotoast = Recipe.create(name: "Avocado Toast", 
        ingredients: "2 slices bread, 1/2 – 3/4 medium ripe avocado, 1-2 Tbsp vegan parmesan, 1 pinch red pepper flake (optional)", 
        instructions: "Toast bread in the oven or toaster. Top with ripe avocado and use a fork to smash. Top with vegan parmesan cheese and (optional) red pepper flake. 
                        Eat, repeat, enjoy!",
 ...
 kalesalad = Recipe.create(name: "Massaged Kale Salad", 
        ingredients: "2 large bundles curly kale, large stems removed and roughly chopped
        1 Tbsp lemon juice
        ...
        Water to thin", 
        instructions: "Once you’ve rinsed and dried your kale, run your hand along the stem to remove the green leaves from the stalky stem. You don’t have to remove the stem completely (we actually enjoy the top 2/3 in the salad), but be sure to compost or reserve the larger bottom stalks for DIY vegetable broth.
...
roastedchicken = Recipe.create(name: "Roasted Chicken", 
        ingredients: "1 3-4 pound whole chicken (organic and free-range or pasture-raised whenever possible)
        2 Tbsp melted butter (Miyoko’s or Earth Balance for dairy-free 
        3/4-1 Tbsp sea salt
        1-2 tsp black pepper
        1 small lemon, rinsed and quartered
        4 sprigs fresh rosemary (or sub thyme)",
        instructions: "NOTE: This chicken does best when prepped 24 hours in advance. If that’s not doable, season and chill at least 8-10 hours before cooking for crispier skin and more flavorful chicken.
